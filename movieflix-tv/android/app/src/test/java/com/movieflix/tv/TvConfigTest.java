...
public class TvConfigTest {
    ...
    public void versaoBateComABuild() {
        assertEquals("4.0.3", TvConfig.VERSAO);
        assertEquals(43, TvConfig.VERSAO_CODIGO);
    }
    ...
    public void mantemNavegacaoDoFilmeNoWebView() {
        ...
        assertTrue(TvConfig.ficaNoWebView("https://movieflix-bszf.onrender.com/apk/MovieFlix-TV-v4.0.3.apk"));
