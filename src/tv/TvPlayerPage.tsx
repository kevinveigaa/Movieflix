 ...
 *
 * - Carrega o player embutido do StreamBetter (mesma fonte do site:
 *   `player` / `video_url` do catálogo — catálogo sempre atualizado,
 *   nenhuma cópia local).
 * - PROTEÇÃO: só monta o iframe depois de verificar auth + assinatura
 *   ativa (mesma regra do PlayerPage do site). Sem assinatura →
 *   redirect para /tv/assinatura. Direto na URL → bloqueado.
