...
const ROUTE_SEO: Array<{ path: string; title: string; description: string }> = [
  ...
  { path: '/documentarios', title: 'Documentários — MovieFlix', description: 'Documentários para assistir online no MovieFlix.' },
  { path: '/infantil', title: 'Infantil — MovieFlix', description: 'Conteúdo infantil selecionado para toda a família no MovieFlix.' },
  { path: '/pesquisa', title: 'Pesquisa — MovieFlix', description: 'Busque filmes, séries, animes e documentários no MovieFlix.' },
